...
#define SENSOR_SERVICE_UUID     BME_SERV_UUID
#define SENSOR_DATA_UUID        BME_DATA_UUID
#define SENSOR_CONFIG_UUID      BME_CONF_UUID
#define SENSOR_PERIOD_UUID      BME_PERI_UUID

#define SENSOR_SERVICE          BME_SERVICE
#define SENSOR_DATA_LEN         BME_DATA_LEN

#define SENSOR_DATA_DESCR       "BME. Data"
#define SENSOR_CONFIG_DESCR     "BME. Conf."
#define SENSOR_PERIOD_DESCR     "BME. Period"
