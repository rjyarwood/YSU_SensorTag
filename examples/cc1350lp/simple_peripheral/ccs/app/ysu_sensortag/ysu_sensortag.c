...
static uint8_t advertData[] =
{
  ...
  0x06,
  GAP_ADTYPE_MANUFACTURER_SPECIFIC, //TODO Abstract these
...
static void SensorTag_init(void)
{
  ...
  //TODO This is where TI initializes their I2C for when we are on the same bus
  /* Call board init functions */
  Board_initI2C();
  System_printf("Init I2C");
  System_flush();
